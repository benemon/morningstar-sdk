...
// editor's backup files. This package is pure Go with no MIDI or
// hardware dependencies; the [sysex] subpackage handles wire-format
// encoding and [Client] (TBD) handles live device I/O.
//
// This package targets the MC8 Pro specifically. Other devices in the
...
// they live (or will live) in sibling packages such as mc6pro.
package mc8pro
